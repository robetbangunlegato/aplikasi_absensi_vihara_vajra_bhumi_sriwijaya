<x-layout bodyClass="g-sidenav-show bg-gray-200">
                                ...
                                <tbody class="text-center" style="">
                                    ...
                                    @foreach ($jabatan_organisasis as $jabatan_organisasi)
                                        <tr>
                                            ...
                                            {{-- menggunakan helper 'number_format()' untuk menampilkan label harga dengan format titik-titik --}}
                                            <td>Rp {{ number_format($jabatan_organisasi->besaran_gaji, 0, ',', '.') }}
                                            </td>
                                            <td>
    ...
    <script>
        $(document).ready(function() {
            ...
            let besaranGaji = $('#besaranGaji').val();
            console.info(besaranGaji);
            $('#besaranGaji').val(new Intl.NumberFormat("id-ID").format(besaranGaji));
